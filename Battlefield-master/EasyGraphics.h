...
/*
  WARNING: Only edit this file if you cannot achieve what you need via inheriting from EasyGraphics or using it as its own object.
           If you edit this file and I release an updated version, you'll not be able to easy update your version
*/
...
protected:
  virtual void onCreate();                                        // See WM_CREATE in MSDN documentation
  virtual void onSize(UINT nType, int cx, int cy);                // See WM_SIZE in MSDN documentation
  ...
  virtual void onDestroy();                                       // See WM_DESTROY in MSDN documentation
